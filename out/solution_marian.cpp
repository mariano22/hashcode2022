...
vector<double> p_value, s_value, c_value;
...
void read_input() {
    ...
    p_name.resize(P); p_takes.resize(P); p_score.resize(P); p_before.resize(P); p_reqs.resize(P); p_value.resize(P); p_reqs_map.resize(P);
    forn(j,P) {
        int n_roles;
...
void clear_problem() {
    ...
    p_name.clear(); p_takes.clear(); p_score.clear(); p_before.clear(); p_reqs.clear(); p_value.clear(); p_reqs_map.clear();
